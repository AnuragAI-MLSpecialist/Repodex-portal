...
const Index = () => {
  ...
  const handleSubmit = async (values, action) => {
    ...
    const resp = await axios.post('https://reportdesk.azurewebsites.net/train_model', values);
    if (resp.success) {
  ...
  return (
    <div className="mt-4">
      ...
      {/* <!-- About --> */}
      <section className="position-relative bg_light_blue contact_form section_pad pt-0 p-4">
        <div className="container">
